...
public class RegexAssignment{
    ...
    public static boolean testPhoneNumber(String phoneNumber){
    	String regex = "\\((404|678|770)\\)\\d{3}-\\d{4}";
    ...
    public static boolean testEmail(String email){
    	String regex = "[a-z][\\w\\-_\\.]*@[a-z][\\w\\-_\\.]*\\.(com|org|net)";
    ...
    public static boolean testName(String name){
    	String regex = "[A-Z][a-zA-z]*((-|')[A-Z])?[a-zA-Z]* [A-Z][a-zA-Z]*((-|')[A-Z])?[a-zA-Z]*";
    ...
    public static boolean testJavaExecutable(String java){
    	String regex = "[\\d\\D]*(public static void main\\(String\\[]) [A-Za-z$_]*[\\w$_]*\\)[\\d\\D]*";
        return java.matches(regex);
    }
}
...
public class Driver {
	...
	private static BSTInterface<User> bst = new AVL<>();
	...
	private static void mainMenu() {
		...
		System.out
				.println("Find - Given a specific username returns the users name.");
		System.out
				.println("List - Displays a list of all users and their usernames sorted alphabetically by username.");
		System.out
				.println("Debug - Prints the BST in nested parenthesized form.");
